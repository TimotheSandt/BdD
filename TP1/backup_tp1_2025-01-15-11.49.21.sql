...
CREATE TABLE `LIGNE` (
  ...
  CONSTRAINT `fk_ligne_article` FOREIGN KEY (`idArticle`) REFERENCES `ARTICLE` (`idArticle`) ON DELETE CASCADE,
  CONSTRAINT `fk_ligne_commande` FOREIGN KEY (`idCommande`) REFERENCES `COMMANDE` (`idCommande`) ON DELETE CASCADE
...
-- Dump completed on 2025-01-15 11:49:21
